...
export const hotel: Category = {
  ...
  items: [
    ...
    },
    {
      ...
      pron: 'フロント デスク',
      pos: '名詞',
      examples: [{ en: 'Please leave your key at the front desk.', ja: '鍵はフロントにお預けください。' }],
    },
    {
      id: 'travel-hotel-017',
      kind: 'word',
      ...
      pron: 'ルーム サービス',
      pos: '名詞',
      examples: [{ en: 'Does this hotel have room service?', ja: 'このホテルにルームサービスはありますか？' }],
    },
    {
      id: 'travel-hotel-018',
      kind: 'word',
      ...
      pron: 'ハウスキーピング',
      pos: '名詞',
      examples: [{ en: 'Housekeeping has not cleaned my room yet.', ja: 'まだ部屋の清掃がされていません。' }],
    },
    {
      id: 'travel-hotel-019',
      kind: 'word',
      ...
      pron: 'キー カード',
      pos: '名詞',
      examples: [{ en: 'My key card does not work.', ja: 'カードキーが使えません。' }],
    },
    {
      id: 'travel-hotel-020',
      kind: 'word',
      ...
      pron: 'ロビー',
      pos: '名詞',
      examples: [{ en: 'Let us meet in the lobby at nine.', ja: '9時にロビーで会いましょう。' }],
    },
    {
      id: 'travel-hotel-021',
      kind: 'phrase',
      en: 'Could I have a non-smoking room?',
      ja: '禁煙の部屋にできますか？',
      examples: [{ en: 'Could I have a non-smoking room, please?', ja: '禁煙の部屋にできますか？' }],
    },
    {
      id: 'travel-hotel-022',
      kind: 'phrase',
      ...
      ja: '部屋に金庫はありますか？',
      examples: [{ en: 'Is there a safe in the room for valuables?', ja: '貴重品用の金庫は部屋にありますか？' }],
    },
    {
      id: 'travel-hotel-023',
      kind: 'phrase',
      ...
      ja: '隣の部屋がとてもうるさいです。',
      examples: [{ en: 'The room next door is very noisy. Could you help?', ja: '隣の部屋がとてもうるさいです。対応してもらえますか？' }],
    },
    {
      id: 'travel-hotel-024',
      kind: 'phrase',
      ...
      ja: '部屋を変えてもらえますか？',
      examples: [{ en: 'Could you change my room to a quieter one?', ja: 'もっと静かな部屋に変えてもらえますか？' }],
    },
    {
      id: 'travel-hotel-025',
      kind: 'phrase',
      ...
      ja: '朝食は何時からですか？',
      examples: [{ en: 'What time does breakfast start tomorrow?', ja: '明日の朝食は何時からですか？' }],
    },
    {
      id: 'travel-hotel-026',
      kind: 'phrase',
      en: 'Could I store my bags after checkout?',
      ja: 'チェックアウト後に荷物を預けられますか？',
      examples: [{ en: 'Could I store my bags here after checkout?', ja: 'チェックアウト後にここで荷物を預けられますか？' }],
    },
    {
      id: 'travel-hotel-027',
      kind: 'phrase',
      en: 'Is there a shuttle to the airport?',
      ja: '空港行きのシャトルバスはありますか？',
      examples: [{ en: 'Is there a free shuttle to the airport?', ja: '空港行きの無料シャトルバスはありますか？' }],
    },
  ],
};
